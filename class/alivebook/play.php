...
$first_story_id = 0;
$guide_sql = "SELECT ag.id, ag.image, ag.contents FROM alivebook_guides ag LEFT JOIN alivebook_guide_mapping agm ON ag.id = agm.guide_id LEFT JOIN alivebooks a ON agm.alivebook_id=a.id WHERE a.id = %d and ag.category='play' LIMIT %d, 1";
$guide_sql = sprintf($guide_sql, $storybook_id, ($page_id-1));
$is_last_page = 0;
$total_page_sql = "SELECT count(ag.id) as cnt FROM alivebook_guides ag LEFT JOIN alivebook_guide_mapping agm ON ag.id = agm.guide_id LEFT JOIN alivebooks a ON agm.alivebook_id=a.id WHERE a.id = %d and ag.category='play'";
$total_page_sql = sprintf($total_page_sql, $storybook_id);
$total_guide_sql = "SELECT count(ag.id) as cnt FROM alivebook_guides ag LEFT JOIN alivebook_guide_mapping agm ON ag.id = agm.guide_id LEFT JOIN alivebooks a ON agm.alivebook_id=a.id WHERE a.id = %d and ag.category='capture'";
        ...
        <div class="container">
            <div class="container-body container-expand">
                <div class="container-body-white-center">
                    ...
                    <div class="alivebox">
                        ...
                        if ($page_id == 1){
                            ...
                            echo "<img onclick=\"location.href='/class/alivebook/play/".$storybook_id."/".($page_id-1)."'\"
                                 class=\"bbtn_left_story\" style=\"cursor: pointer;\"
                                 src=\"/img/scroll-btn(left).png\"
                                 srcset=\"/img/scroll-btn(left)@2x.png 2x,/img/scroll-btn(left)@3x.png 3x\"/>";
                        }
             ...
             /img/grayarrow_middle@3x.png 3x" />
                        ...
                        <div class="Sentence">
                            <img class="arrow_last" src="/img/greenarrow_last.png" srcset="/img/greenarrow_last@2x.png 2x,
