                    ...
                    $i=0;
                        foreach($result as $row){
                            if($row["id"]==1){
                                ...
                                echo "<button style='width: 100%; margin-top: 7px; border-style: double; border-color: #ffa300; cursor: pointer; height: 50px; border-radius: 4px;' onclick='down(this)'><a href='".$row["workbook"]."' style='font-size: 15px; text-decoration: none; color: #ffa300;' download>".$row["title"]." - Workbook Download</a></button>";
                                echo "</div>";
                                echo "</div>";
                            }else{
                                echo "<div class='grid-item'>";
